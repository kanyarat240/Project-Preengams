import { Component, OnInit, Input, Output, EventEmitter, SimpleChanges, forwardRef, OnChanges } from '@angular/core';
...
export class PaginationComponent implements OnChanges {  @Input() currentPage = 1;
